...
?>
  ...
  <section class="main_content">
      ...
      <div class="patient_dashboard">
       <div class="cards">
             <div href="#" class="card" onclick="location.href='<?php echo urlFor("doctor/profile.php"); ?>';">
               <i class="card_icon fas fa-user"></i>
               <a href="#">My Profile</a>
             </div>
             <div class="card" onclick="location.href='<?php echo urlFor("doctor/prescription_requests.php"); ?>';">
               <i class="card_icon fas fa-capsules"></i>
               <a href="#">Prescription Requests</a>
             </div>
             <div  class="card" onclick="location.href='<?php echo urlFor("doctor/my_appointments.php"); ?>';" >
               <i class="card_icon fas fa-calendar-check" ></i>
               <a href="#">My Appointments</a>
             </div>
             <div class="card" onclick="location.href='<?php echo urlFor("doctor/doctor_answered_prescriptions.php"); ?>';">
